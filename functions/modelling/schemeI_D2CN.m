function [Q,OpenPositions,P] = figureModel2_minusC1(Params) 
% figureModel2_minusC1 Defined with the DrawModel GUI and programmatically generated 
% through constructModelCode. 
% 	 [Q,OpenPositions,P] = figureModel2_minusC1(Params) Generate transition matrix Q parameterized by
...
preQ{3,3} = @(V) -beta_k*x_beta*y_beta*exp(-37.435377*V*beta_q)-gamma_ik*exp(-37.435377*V*gamma_iq)-r_k*y_beta^3*exp(-37.435377*V*r_q);
preQ{4,3} = @(V) gamma_ik*exp(-37.435377*V*gamma_iq);
...
preQ{7,7} = @(V) -ii_k*y_alpha^3*exp(-37.435377*V*ii_q)-beta_k*x_beta*exp(-37.435377*V*beta_q)-gamma_4k*exp(-37.435377*V*gamma_4q)-beta_4k*x_beta^3*exp(-37.435377*V*beta_4q);
preQ{8,7} = @(V) gamma_4k*exp(-37.435377*V*gamma_4q);
